  ...
  <div class="card">
    ...
    <div class="table-responsive">
      <table class="table align-items-center table-flush">
        ...
        <tbody class="list">
          <tr>
            <td>Possession de stupéfiants</td>
            <td>
              <button class="btn btn-sm btn-success">Attachement</button>
              <button
                data-toggle="modal"
                data-target="#viewCase"
